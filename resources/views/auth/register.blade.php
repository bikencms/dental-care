...
@section('title', 'Vietnam Dental Care - Sign in page')
@section('header_title', 'Sign in to our platform')
@section('content')
<form method="POST" action="{{ route('register') }}" class="mt-4 mb-4">
    @csrf
    <!-- Form -->
    <div class="form-group mb-4">
        ...
        <div class="input-group">
            ...
            <input type="text" name="name" value="{{ old('name') }}" class="form-control" placeholder="Your Name" id="name" autofocus required>
        </div>  
    </div>
    <div class="form-group mb-4">
        ...
        <div class="input-group">
            ...
            <input type="email" name="email" value="{{ old('email') }}" class="form-control" placeholder="example@company.com" id="email" autofocus required>
        </div>  
    </div>
    <!-- End of Form -->
    <div class="form-group">
        ...
        <div class="form-group mb-4">
            ...
            <div class="input-group">
                ...
                <input type="password" name="password_confirmation" placeholder="Password" class="form-control" id="password" required>
            </div>  
        </div>
        <!-- End of Form -->
        <!-- Form -->
